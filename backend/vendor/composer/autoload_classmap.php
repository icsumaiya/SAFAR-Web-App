...
return array(
    'ActivateAgencyCommand' => $baseDir . '/admin/includes/command/ActivateAgencyCommand.php',
    'AdminDashboardService' => $baseDir . '/admin/includes/AdminDashboardService.php',
    'AdminFacade' => $baseDir . '/admin/includes/facade/AdminFacade.php',
    'AdminStatsObserver' => $baseDir . '/admin/includes/observer/AdminStatsObserver.php',
    'AgencyCommandFactory' => $baseDir . '/admin/includes/AgencyCommandFactory.php',
    'AgencyDetailsService' => $baseDir . '/admin/includes/AgencyDetailsService.php',
    'AgencySearchQueryBuilder' => $baseDir . '/admin/includes/AgencySearchQueryBuilder.php',
    'AgencyService' => $baseDir . '/admin/includes/facade/AdminFacade.php',
    'AgencyStatsObserver' => $baseDir . '/admin/includes/observer/AgencyStatsObserver.php',
    'ApproveAgencyCommand' => $baseDir . '/admin/includes/command/ApproveAgencyCommand.php',
    'BookingDetailsService' => $baseDir . '/admin/includes/BookingDetailsService.php',
    'BookingManagementHelper' => $baseDir . '/admin/includes/BookingManagementHelper.php',
    'BookingObserver' => $baseDir . '/admin/includes/observer/BookingObserver.php',
    'BookingRequestValidator' => $baseDir . '/admin/includes/BookingRequestValidator.php',
    'BookingSearchQueryBuilder' => $baseDir . '/admin/includes/BookingSearchQueryBuilder.php',
    'BookingService' => $baseDir . '/admin/includes/facade/AdminFacade.php',
    'BookingSubject' => $baseDir . '/admin/includes/observer/BookingSubject.php',
    'Command' => $baseDir . '/admin/includes/command/Command.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'Database' => $baseDir . '/admin/includes/Database.php',
    'FilterContext' => $baseDir . '/admin/includes/strategy/FilterContext.php',
    'FilterStrategy' => $baseDir . '/admin/includes/strategy/FilterStrategy.php',
    'HotelDataAdapter' => $baseDir . '/admin/includes/adapter/HotelDataAdapter.php',
    'ListingFilterFactory' => $baseDir . '/admin/includes/ListingFilterFactory.php',
    'LocationFilter' => $baseDir . '/admin/includes/strategy/LocationFilter.php',
    ...
    'Package' => $baseDir . '/admin/includes/PackageFactory.php',
    'PackageFactory' => $baseDir . '/admin/includes/PackageFactory.php',
    'PackageSearchQueryBuilder' => $baseDir . '/admin/includes/PackageSearchQueryBuilder.php',
    'PackageService' => $baseDir . '/admin/includes/facade/AdminFacade.php',
    'PackageValidator' => $baseDir . '/admin/includes/PackageValidator.php',
    'PaymentSearchQueryBuilder' => $baseDir . '/admin/includes/PaymentSearchQueryBuilder.php',
    'PaymentService' => $baseDir . '/admin/includes/PaymentService.php',
    'PaymentValidator' => $baseDir . '/admin/includes/PaymentValidator.php',
    ...
    'PriceMaxFilter' => $baseDir . '/admin/includes/strategy/PriceMaxFilter.php',
    'RejectAgencyCommand' => $baseDir . '/admin/includes/command/RejectAgencyCommand.php',
    ...
    'SuspendAgencyCommand' => $baseDir . '/admin/includes/command/SuspendAgencyCommand.php',
    ...
    'TravelerBookingSearchQueryBuilder' => $baseDir . '/admin/includes/TravelerBookingSearchQueryBuilder.php',
    'TypeFilter' => $baseDir . '/admin/includes/strategy/TypeFilter.php',
    'UnverifyAgencyCommand' => $baseDir . '/admin/includes/command/UnverifyAgencyCommand.php',
    'UserManagementValidator' => $baseDir . '/admin/includes/UserManagementValidator.php',
    'UserSearchQueryBuilder' => $baseDir . '/admin/includes/UserSearchQueryBuilder.php',
    'UserService' => $baseDir . '/admin/includes/facade/AdminFacade.php',
