...
class ComposerStaticInit65c8b4fba76906d2d00883f5e94b80d8
{
    ...
    public static $classMap = array (
        'ActivateAgencyCommand' => __DIR__ . '/../..' . '/admin/includes/command/ActivateAgencyCommand.php',
        'AdminDashboardService' => __DIR__ . '/../..' . '/admin/includes/AdminDashboardService.php',
        'AdminFacade' => __DIR__ . '/../..' . '/admin/includes/facade/AdminFacade.php',
        'AdminStatsObserver' => __DIR__ . '/../..' . '/admin/includes/observer/AdminStatsObserver.php',
        'AgencyCommandFactory' => __DIR__ . '/../..' . '/admin/includes/AgencyCommandFactory.php',
        'AgencyDetailsService' => __DIR__ . '/../..' . '/admin/includes/AgencyDetailsService.php',
        'AgencySearchQueryBuilder' => __DIR__ . '/../..' . '/admin/includes/AgencySearchQueryBuilder.php',
        'AgencyService' => __DIR__ . '/../..' . '/admin/includes/facade/AdminFacade.php',
        'AgencyStatsObserver' => __DIR__ . '/../..' . '/admin/includes/observer/AgencyStatsObserver.php',
        'ApproveAgencyCommand' => __DIR__ . '/../..' . '/admin/includes/command/ApproveAgencyCommand.php',
        'BookingDetailsService' => __DIR__ . '/../..' . '/admin/includes/BookingDetailsService.php',
        'BookingManagementHelper' => __DIR__ . '/../..' . '/admin/includes/BookingManagementHelper.php',
        'BookingObserver' => __DIR__ . '/../..' . '/admin/includes/observer/BookingObserver.php',
        'BookingRequestValidator' => __DIR__ . '/../..' . '/admin/includes/BookingRequestValidator.php',
        'BookingSearchQueryBuilder' => __DIR__ . '/../..' . '/admin/includes/BookingSearchQueryBuilder.php',
        'BookingService' => __DIR__ . '/../..' . '/admin/includes/facade/AdminFacade.php',
        'BookingSubject' => __DIR__ . '/../..' . '/admin/includes/observer/BookingSubject.php',
        'Command' => __DIR__ . '/../..' . '/admin/includes/command/Command.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'Database' => __DIR__ . '/../..' . '/admin/includes/Database.php',
        'FilterContext' => __DIR__ . '/../..' . '/admin/includes/strategy/FilterContext.php',
        'FilterStrategy' => __DIR__ . '/../..' . '/admin/includes/strategy/FilterStrategy.php',
        'HotelDataAdapter' => __DIR__ . '/../..' . '/admin/includes/adapter/HotelDataAdapter.php',
        'ListingFilterFactory' => __DIR__ . '/../..' . '/admin/includes/ListingFilterFactory.php',
        'LocationFilter' => __DIR__ . '/../..' . '/admin/includes/strategy/LocationFilter.php',
        ...
        'Package' => __DIR__ . '/../..' . '/admin/includes/PackageFactory.php',
        'PackageFactory' => __DIR__ . '/../..' . '/admin/includes/PackageFactory.php',
        'PackageSearchQueryBuilder' => __DIR__ . '/../..' . '/admin/includes/PackageSearchQueryBuilder.php',
        'PackageService' => __DIR__ . '/../..' . '/admin/includes/facade/AdminFacade.php',
        'PackageValidator' => __DIR__ . '/../..' . '/admin/includes/PackageValidator.php',
        'PaymentSearchQueryBuilder' => __DIR__ . '/../..' . '/admin/includes/PaymentSearchQueryBuilder.php',
        'PaymentService' => __DIR__ . '/../..' . '/admin/includes/PaymentService.php',
        'PaymentValidator' => __DIR__ . '/../..' . '/admin/includes/PaymentValidator.php',
        ...
        'PriceMaxFilter' => __DIR__ . '/../..' . '/admin/includes/strategy/PriceMaxFilter.php',
        'RejectAgencyCommand' => __DIR__ . '/../..' . '/admin/includes/command/RejectAgencyCommand.php',
        ...
        'SuspendAgencyCommand' => __DIR__ . '/../..' . '/admin/includes/command/SuspendAgencyCommand.php',
        ...
        'TravelerBookingSearchQueryBuilder' => __DIR__ . '/../..' . '/admin/includes/TravelerBookingSearchQueryBuilder.php',
        'TypeFilter' => __DIR__ . '/../..' . '/admin/includes/strategy/TypeFilter.php',
        'UnverifyAgencyCommand' => __DIR__ . '/../..' . '/admin/includes/command/UnverifyAgencyCommand.php',
        'UserManagementValidator' => __DIR__ . '/../..' . '/admin/includes/UserManagementValidator.php',
        'UserSearchQueryBuilder' => __DIR__ . '/../..' . '/admin/includes/UserSearchQueryBuilder.php',
        'UserService' => __DIR__ . '/../..' . '/admin/includes/facade/AdminFacade.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit65c8b4fba76906d2d00883f5e94b80d8::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit65c8b4fba76906d2d00883f5e94b80d8::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit65c8b4fba76906d2d00883f5e94b80d8::$classMap;
