...
<aside style="width: 250px; background: var(--white); border-radius: var(--radius); padding: 20px; box-shadow: var(--shadow-sm); border: 1px solid var(--glass-border); position: sticky; top: 100px; align-self: flex-start;">
    ...
    <ul style="list-style: none; padding: 0; margin: 0;">
        ...
        <li style="margin-bottom: 8px;">
            <a href="payments.php" style="display: block; padding: 10px; border-radius: 8px; transition: var(--transition); <?php echo navClass('payments', $active); ?>">
                <i class="fas fa-money-bill-wave" style="width: 20px;"></i> Manage Payments
            </a>
        </li>
        <li style="margin-bottom: 8px;">
